    ...
    if (rut == "" || clave == "") {
        ...
        $.ajax({
            ...
            if (msg.msg == "error") {
                ...
                window.location.href = 'https://www.tarreoinformatica2019.com/Administrador';
    ...
    if (rut == "" || clave == "") {
        ...
        $.ajax({
            ...
            if (msg.msg == "error") {
                ...
                window.location.href = 'https://www.tarreoinformatica2019.com/Participante';
...
function salir() {
    ...
    window.location.href = 'https://www.tarreoinformatica2019.com/';
}
...
function getFechasJuegos() {
    var hola = 'https://www.tarreoinformatica2019.com/getFechasJuegos';

    $("#vertical-timeline").empty();
    $.getJSON(hola, function (result) {
        $.each(result, function (i, o) {

            var fila = '<div class="vertical-timeline-block"><div class="vertical-timeline-icon navy-bg"><i class="fa fa-users"></i></div>   <div class="vertical-timeline-content"><h2 style="color: black;">' + o.nombreJuego + '</h2><h2 style="color: black;">Tipo Juego: ' + o.tipo + '</h2><h2 style="color: black;">Descripci贸n: ' + o.descripcionJuego + '</h2><h2 style="color: black;">Fecha: ' + o.fecha + '</h2><a href="#" class="btn btn-xs btn-primary" data-toggle="modal" data-target=".modal-login">Postularme</a></div></div>';
...
function agregarPostulante(idJuego, idUsuario) {
    ...
    if (idJuego == "" || idUsuario == "") {
        ...
        $.ajax({
            ...
            if (msg.msg == "ok") {
                toastr.success("Te haz Suscrito a este Juego", "Exito en la Acci贸n!!!")
...
function agregarSolicitud(idEquipo, idUsuario) {
    ...
    if (idEquipo == "" || idUsuario == "") {
        ...
        $.ajax({
            ...
            if (msg.msg == "ok") {
                toastr.success("Solicitud enviada con Exito", "Exito en la Acci贸n!!!")
...
function rechazarParticipante(idParticipante, idJuego, id) {
    ...
    if (idParticipante == "" || idJuego == "" || id == "") {
        ...
        $.ajax({
            ...
            if (msg.msg == "ok") {
                toastr.success("Participante Rechazado", "Exito en la Acci贸n!!!")
                toastr.options = { "closeButton": true, "debug": false, "progressBar": true, "preventDuplicates": false, "positionClass": "toast-top-right", "onclick": null, "showDuration": "400", "hideDuration": "1000", "timeOut": "4000", "extendedTimeOut": "1000", "showEasing": "swing", "hideEasing": "swing", "showMethod": "show", "hideMethod": "fadeOut" }
            } else if (msg.msg == "error") {
...
function aceptarParticipante(idParticipante, idJuego, id) {
    ...
    if (idParticipante == "" || idJuego == "" || id == "") {
        ...
        $.ajax({
            ...
            if (msg.msg == "ok") {
                toastr.success("Participante Aceptado", "Exito en la Acci贸n!!!")
                toastr.options = { "closeButton": true, "debug": false, "progressBar": true, "preventDuplicates": false, "positionClass": "toast-top-right", "onclick": null, "showDuration": "400", "hideDuration": "1000", "timeOut": "4000", "extendedTimeOut": "1000", "showEasing": "swing", "hideEasing": "swing", "showMethod": "show", "hideMethod": "fadeOut" }
            } else if (msg.msg == "error") {
                toastr.error("Error", "Puede que ya este en otro Equipo...")
                toastr.options = { "closeButton": true, "debug": false, "progressBar": true, "preventDuplicates": false, "positionClass": "toast-top-right", "onclick": null, "showDuration": "400", "hideDuration": "1000", "timeOut": "4000", "extendedTimeOut": "1000", "showEasing": "swing", "hideEasing": "swing", "showMethod": "show", "hideMethod": "fadeOut" }
...
function addComentario() {
    ...
    if (titulo == "" || comentario == "" || admin == "" || equipo == "") {
        ...
        $.ajax({
            ...
            if (msg.msg == "ok") {
                toastr.success("Comentario Adjuntado con Exito", "Exito en la Acci贸n!!!")
                $("#titulo").val("");
                $("#descripcion").val("");
                toastr.options = { "closeButton": true, "debug": false, "progressBar": true, "preventDuplicates": false, "positionClass": "toast-top-right", "onclick": null, "showDuration": "400", "hideDuration": "1000", "timeOut": "4000", "extendedTimeOut": "1000", "showEasing": "swing", "hideEasing": "swing", "showMethod": "show", "hideMethod": "fadeOut" }
            } else if (msg.msg == "error") {
...
function verEquiposPublico() {
    var hola = 'https://www.tarreoinformatica2019.com/getJuegosPublico';
    $("#equiposPublico").empty();
    $.getJSON(hola, function (result) {
        $.each(result, function (i, o) {


            var fila = '<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12"><center><h2>' + o.nombreEquipo + '</h2><img src="https://www.tarreoinformatica2019.com/lib/img/Equipos/' + o.fotoEquipo + '" class="img-responsive" style="height:400px; width:400px;" alt="SK Telecom T1" />            <p style="text-align: justify"><span>Juego: </span>'+o.nombreJuego+'</br>' + o.descripcionEquipo + '</p>        </center>        <p><button type="button" id="btnVerEquipo" class="btn btn-info" data-toggle="modal" data-target="#modal-integrantes" value="' + o.idEquipo + '">Ver Integrantes &raquo;</button></p>    </div>';
...
function editarEstado() {
    ...
    if (id=="" || estado == null) {
        ...
        $.ajax({
            ...
            if (msg.msg == "ok") {
                toastr.success("Estado Editado", "Exito en la Acci贸n!!!")
                $("#titulo").val("");
                $("#descripcion").val("");
                toastr.options = { "closeButton": true, "debug": false, "progressBar": true, "preventDuplicates": false, "positionClass": "toast-top-right", "onclick": null, "showDuration": "400", "hideDuration": "1000", "timeOut": "4000", "extendedTimeOut": "1000", "showEasing": "swing", "hideEasing": "swing", "showMethod": "show", "hideMethod": "fadeOut" }
            } else if (msg.msg == "error") {
...
function verIntegrantesPublicos(datos){
    var id = datos;
    if (id == "") {
        toastr.error("Verifique todos los campos", "Ingrese todos los datos!!!")
    } else {
        $.ajax({
            url: 'getIntegratesEquipoPublico',
            type: 'POST',
            dataType: 'json',
            data: { "id": id }
        }).then(function (msg) {
...
function eliminarPostulacion(id) {
    ...
    if (id == "") {
        ...
        $.ajax({
            url: 'eliminarPostulacion',
            type: 'POST',
            dataType: 'json',
            data: { "id": id }
        }).then(function (msg) {
            if (msg.msg == "ok") {
                toastr.success("Postulacion Eliminada", "Exito en la Accion!!!")
                toastr.options = { "closeButton": true, "debug": false, "progressBar": true, "preventDuplicates": false, "positionClass": "toast-top-right", "onclick": null, "showDuration": "400", "hideDuration": "1000", "timeOut": "4000", "extendedTimeOut": "1000", "showEasing": "swing", "hideEasing": "swing", "showMethod": "show", "hideMethod": "fadeOut" }
            } else if (msg.msg == "vacio") {
                toastr.error("Error", "Ocurrio un error al borrar su postulacion. Actualize la pagina.")
                toastr.options = { "closeButton": true, "debug": false, "progressBar": true, "preventDuplicates": false, "positionClass": "toast-top-right", "onclick": null, "showDuration": "400", "hideDuration": "1000", "timeOut": "4000", "extendedTimeOut": "1000", "showEasing": "swing", "hideEasing": "swing", "showMethod": "show", "hideMethod": "fadeOut" }
            }
        });
    }
    ...
    if (asunto == "" || descripcion == "") {
        ...
        $.ajax({
            ...
            if (msg.msg == "ok") {
                $("#asunto").val("");
                $("#descripcion").val("");
                toastr.success("Sugerencia enviada, gracias!!!", "Exito en la Acci髇!!!")
                toastr.options = { "closeButton": true, "debug": false, "progressBar": true, "preventDuplicates": false, "positionClass": "toast-top-right", "onclick": null, "showDuration": "400", "hideDuration": "1000", "timeOut": "4000", "extendedTimeOut": "1000", "showEasing": "swing", "hideEasing": "swing", "showMethod": "show", "hideMethod": "fadeOut" }
