...
$route['Solicitudes'] = 'participante/Solicitudes';
$route['verSolicitudesXParticipante'] = 'participante/verSolicitudesXParticipante';
$route['getIntegratesEquipoPublico'] = 'welcome/getIntegratesEquipoPublico';
$route['eliminarPostulacion'] = 'participante/eliminarPostulacion';
$route['Perfil'] = 'participante/Perfil';
$route['editarPerfil'] = 'participante/editarPerfil';
$route['addSugerencia'] = 'participante/addSugerencia';
