                ...
                <div class="wrapper wrapper-content  animated fadeInRight">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <form  method="post" action="https://www.tarreoinformatica2019.com/agregarParticipante" enctype="multipart/form-data" autocomplete="off" target="_top">

                                <div class="form-group col-lg-3 col-md-3 col-sm-4 col-xs-12"><label>Rut</label><input id="username" required type="text" name="j_username" class="form-control" oninput="checkRut(this)"></div>                                <div class="form-group col-lg-3 col-md-3 col-sm-4 col-xs-12"><label>Nombres</label> <input type="text"  required name="nombres" placeholder="Ingrese Nombres" class="form-control"></div>
