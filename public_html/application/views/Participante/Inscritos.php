                        ...
                        <div class="ibox-content">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <form id="login" name="login" method="post" action="https://www.tarreoinformatica2019.com/addEquipo" enctype="multipart/form-data">
            ...
            $(document).ready(function() {
                ...
                $('.dataTables-juegosIndividuales').DataTable({
                    ...
                    "columnDefs": [{
                            ...
                            "defaultContent": '<button type="button" id="btnAddEquipo" class="btn btn-info" data-toggle="modal" data-target="#modal-participantes"><i class="fa fa-eye"></i></button><button type="button" id="btnEliminar" class="btn" ><i class="fa fa-ban"></i></button>'
                    ...
                    eliminarPostulacion($(idJuego).text());

                    var table = $('.dataTables-juegosIndividuales').DataTable();

                    table.ajax.reload(function(json) {
                        $('#btnEliminar').val(json.lastInput);
                    });
                });
