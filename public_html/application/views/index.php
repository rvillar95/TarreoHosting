...
<body id="page-top" class="landing-page">
        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
            ...
            <div class="container">
                ...
                <div class="navbar-header page-scroll">
                    ...
                    <a class="navbar-brand" style="background-color: transparent" href="<?php echo base_url() ?>"> <img src="<?php echo base_url() ?>lib/img/logo.png" style="width: 150px; height: 50px;" alt="" /></a>
			...
			<li><a class="page-scroll" href="#even">Fechas</a></li>
    ...
    <div id="inSlider" class="carousel carousel-fade img-responsive" data-ride="carousel">
            ...
            <div class="item active img-responsive">
                ...
                <div class="container">
                    ...
                    <div class="carousel-caption">
                        ...
                        <h3><b>TARREO INACAP TALCA 2019.</b></h3>
                        <h3><b>DÍA JUEVES 29 DE AGOSTO A PARTIR DE LAS 10:00 HORAS.</b></h3>
	 ...
	 <section id="" class="blue-bg">

        <center>

            <div class="row" style="padding: 10px;">
	<center>	<h1>Torneo de League Of Legends</h1> </center>

                <div class="row">

<iframe src="https://challonge.com/es/yiyklpyx/module" width="100%" height="500" frameborder="0" scrolling="auto" allowtransparency="true"></iframe>
    ...
    <section class="timeline blue-bg" id="even">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content animated bounceInRight">
                <div class="modal-header">
                    ...
                    <small class="font-bold">Conoce a tus contrincantes.</small>
                </div>
                <div class="modal-body">
            ...
            <div class="modal-content animated bounceInRight">
                ...
                <div class="modal-header">
                    ...
                    <h1><strong>
                        ...
                        <center><b>
                        <a href="https://drive.google.com/drive/folders/1Y35hl9aQA36BTBH3rfyQCRB1NsiqyAfb">CLIC EN EL TEXTO AZUL - BASES DE LOS JUEGOS</a>
                        <br><br>
                        <p  align="justify">
                        Valor inscripción individual: $500
                        <br>
                        Valor inscripción grupal (LOL - CS GO): $2500
                        <br>
                        El sitio asegura la pre-inscripción y para efectuar la participación se deberá pagar de manera presencial el día del evento.
                        </p>
                        </b>
                        </center>
                ...
                <center><img src="<?php echo base_url() ?>lib/img/admin/tarreo.jpg" class="img-responsive"> </center>
